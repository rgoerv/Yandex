            ...
            if(ParseQueryWord(word, query_word)) {
                ...
                if (!query_word.is_stop) {
                    ...
                    if (query_word.is_minus) {
                        ...
                        if(QueryWord query_word_last;
                        ParseQueryWord(query_word.data, query_word_last)){
...
int main() {
    ...
    if (search_server.FindTopDocuments("fluffy dog and --fancy collar"s, documents)) {
