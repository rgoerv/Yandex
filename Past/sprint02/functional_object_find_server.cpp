...
//     search_server.AddDocument(42, "black cat with collar in the city "s, DocumentStatus::ACTUAL, {1, 2, 3});
//     cout << "ACTUAL by default:"s << endl;
//     for (const Document& document : search_server.FindTopDocuments("in"s)) {
...
//     const auto [words, status] = search_server.MatchDocument("cat in the city for sale -sale -lang -collar"s, 42);
//     PrintMatchDocumentResult(42, words, status);
